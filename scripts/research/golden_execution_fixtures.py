...
def golden_events() -> list[dict[str, Any]]:
    return [
        ...
        {"event_type": "fill", "fill_id": "golden-f1", "order_id": "golden-o1", "symbol": "600000.SH", "side": "BUY", "shares": 100, "raw_price": 10.1, "execution_date": "2026-01-06", "costs": {"commission": 5.0, "transfer_fee": 0.01}},
