...
# PR26A.10: manifest.json and evidence_verification.json are NOT in
...
# manifest.  verification_file_sha = sha256_file(evidence_verification.json)
# is stored in the manifest after finalization to bind the actual file.
