"""Reproducible strict-precommit account validation bundle for Issue #134."""
...
def main() -> None:
    ...
    p.add_argument("--resume", action="store_true"); p.add_argument("--checkpoint-every", type=int, default=20)
