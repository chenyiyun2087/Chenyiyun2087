...
echo "Stopping Chenyiyun2087 scheduler..."
pkill -f "$PROJECT_DIR/scheduler.py" 2>/dev/null || true
...
echo "Starting Chenyiyun2087 scheduler..."
bash "$PROJECT_DIR/start_scheduler.sh"
