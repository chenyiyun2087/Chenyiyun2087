...
> 评估时间：2026-07-27T13:38:06+08:00；策略：`production_governed_vol_position_v1_2b_dynamic_score`；release：`champion-v1-2b-dynamic-score-20260618`。
...
| PR-B | `pr_b_formal_readiness` | BLOCKED | BLOCKED |
...
| 评估报告 | `comprehensive_report` | PASS | 已生成并等待Artifact校验 | 发布前完成Artifact与UTF-8校验。 |
