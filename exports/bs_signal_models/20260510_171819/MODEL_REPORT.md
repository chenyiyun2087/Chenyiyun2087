...
- 生成时间：2026-05-10T17:18:19
- 数据目录：`exports/signal_enhancement/20260510_171721`
- 目标：`hit_20_10pct`
- 特征数：32
- 训练/校准/测试：476 / 40 / 68
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260510_171819/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| logistic_calibrated | train | 476 | 0.254202 | 0.24535 | 0.16568 | 0.211574 | 0.0 | 0.0 | 0.0 |
| logistic_calibrated | validation | 40 | 0.3 | 0.541667 | 0.404092 | 0.208256 | 0.4 | 0.3 | 0.266667 |
| logistic_calibrated | test | 68 | 0.367647 | 0.462326 | 0.378889 | 0.238599 | 0.6 | 0.35 | 0.266667 |
