...
- 生成时间：2026-05-11T13:37:52
- 数据目录：`/Volumes/extension/projects/Chenyiyun2087/exports/signal_enhancement/20260511_133718`
- 目标：`hit_20_10pct`
- 特征数：47
- 训练/校准/测试：449 / 11 / 60
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260511_133752_050073/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| hist_gradient_boosting | train | 449 | 0.267261 | 0.875304 | 0.766154 | 0.168085 | 1.0 | 0.95 | 0.966667 |
| hist_gradient_boosting | validation | 11 | 0.0 | None | None | 0.07341 | 0.0 | 0.0 | 0.0 |
| hist_gradient_boosting | test | 60 | 0.35 | 0.54823 | 0.386672 | 0.22815 | 0.3 | 0.45 | 0.333333 |
