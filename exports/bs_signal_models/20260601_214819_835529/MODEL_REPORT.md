...
- 生成时间：2026-06-01T21:48:19
- 数据目录：`/Volumes/extension/projects/Chenyiyun2087/exports/signal_enhancement/20260601_214503`
- 目标：`hit_20_10pct`
- 特征数：167
- 训练/校准/测试：997 / 44 / 226
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260601_214819_835529/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| hist_gradient_boosting | train | 997 | 0.328987 | 1.0 | 1.0 | 0.185923 | 1.0 | 1.0 | 1.0 |
| hist_gradient_boosting | validation | 44 | 0.090909 | 0.825 | 0.309676 | 0.074344 | 0.2 | 0.2 | 0.133333 |
| hist_gradient_boosting | test | 226 | 0.424779 | 0.579247 | 0.50796 | 0.347557 | 0.7 | 0.65 | 0.533333 |
