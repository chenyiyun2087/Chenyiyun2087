...
- 生成时间：2026-05-11T14:35:57
- 数据目录：`/Volumes/extension/projects/Chenyiyun2087/exports/signal_enhancement/20260511_143431`
- 目标：`hit_20_10pct`
- 特征数：153
- 训练/校准/测试：449 / 11 / 60
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260511_143557_089569/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| logistic_calibrated | train | 449 | 0.267261 | 0.890426 | 0.724038 | 0.176591 | 0.8 | 0.85 | 0.766667 |
| logistic_calibrated | validation | 11 | 0.0 | None | None | 0.093667 | 0.0 | 0.0 | 0.0 |
| logistic_calibrated | test | 60 | 0.35 | 0.724054 | 0.486704 | 0.224587 | 0.5 | 0.45 | 0.566667 |
