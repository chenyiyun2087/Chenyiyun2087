...
- 生成时间：2026-05-11T14:36:04
- 数据目录：`/Volumes/extension/projects/Chenyiyun2087/exports/signal_enhancement/20260511_143431`
- 目标：`hit_20_10pct`
- 特征数：153
- 训练/校准/测试：449 / 11 / 60
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260511_143603_497398/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| hist_gradient_boosting | train | 449 | 0.267261 | 0.96421 | 0.930473 | 0.14699 | 1.0 | 1.0 | 1.0 |
| hist_gradient_boosting | validation | 11 | 0.0 | None | None | 0.085266 | 0.0 | 0.0 | 0.0 |
| hist_gradient_boosting | test | 60 | 0.35 | 0.598291 | 0.448643 | 0.230433 | 0.6 | 0.4 | 0.433333 |
