...
- 生成时间：2026-05-11T22:32:11
- 数据目录：`exports/signal_enhancement/20260511_143431`
- 目标：`hit_20_10pct`
- 特征数：153
- 训练/校准/测试：449 / 11 / 60
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260511_223211_217548/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| random_forest | train | 449 | 0.267261 | 0.957421 | 0.891411 | 0.146457 | 1.0 | 1.0 | 1.0 |
| random_forest | validation | 11 | 0.0 | None | None | 0.084865 | 0.0 | 0.0 | 0.0 |
| random_forest | test | 60 | 0.35 | 0.642247 | 0.512269 | 0.23014 | 0.6 | 0.5 | 0.433333 |
