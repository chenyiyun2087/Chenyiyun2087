...
- 生成时间：2026-05-10T18:16:51
- 数据目录：`exports/signal_enhancement/20260510_181625`
- 目标：`hit_20_10pct`
- 特征数：45
- 训练/校准/测试：476 / 40 / 68
- 最新候选输出：`/Volumes/extension/projects/Chenyiyun2087/exports/bs_signal_models/20260510_181651/latest_candidates_scored.csv`

## 指标

| model | split | rows | positive_rate | roc_auc | average_precision | brier | precision@10 | precision@20 | precision@30 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| logistic_calibrated | train | 476 | 0.254202 | 0.787638 | 0.555777 | 0.17047 | 0.7 | 0.75 | 0.666667 |
| logistic_calibrated | validation | 40 | 0.3 | 0.568452 | 0.447236 | 0.207285 | 0.5 | 0.35 | 0.266667 |
| logistic_calibrated | test | 68 | 0.367647 | 0.594419 | 0.431399 | 0.234165 | 0.4 | 0.4 | 0.433333 |
