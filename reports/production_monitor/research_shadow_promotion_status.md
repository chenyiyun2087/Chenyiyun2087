...
- promotion_statuses: `NOT_READY_CALENDAR_WINDOW, NOT_READY_NO_EVENTS, NOT_READY_EXECUTION_PROXY, NOT_READY_INCREMENTAL_EXECUTION, PATTERN_LINEAGE_WARNING, FP_SEPARABILITY_EXPLANATION_ONLY`
- blocking_statuses: `NOT_READY_CALENDAR_WINDOW, NOT_READY_NO_EVENTS, NOT_READY_EXECUTION_PROXY, NOT_READY_INCREMENTAL_EXECUTION`
