...
- shadow_pass: `False`
- shadow_fail_reasons: `risk_decision_diff_days_above_threshold, execution_degraded_days_above_threshold, large_slippage_proxy_days_above_threshold, limit_up_buy_risk_days_above_threshold`
