...
CREATE TABLE IF NOT EXISTS em_individual_fund_flow (
    ...
    main_net_amount DECIMAL(20, 2) COMMENT '主力净流入净额',
    main_net_ratio DECIMAL(10, 4) COMMENT '主力净流入占比',
    super_net_amount DECIMAL(20, 2) COMMENT '超大单净流入净额',
    super_net_ratio DECIMAL(10, 4) COMMENT '超大单净流入占比',
    big_net_amount DECIMAL(20, 2) COMMENT '大单净流入净额',
    big_net_ratio DECIMAL(10, 4) COMMENT '大单净流入占比',
    mid_net_amount DECIMAL(20, 2) COMMENT '中单净流入净额',
    mid_net_ratio DECIMAL(10, 4) COMMENT '中单净流入占比',
    small_net_amount DECIMAL(20, 2) COMMENT '小单净流入净额',
    small_net_ratio DECIMAL(10, 4) COMMENT '小单净流入占比',
    raw_json JSON COMMENT '原始JSON数据',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uk_stock_date (stock_code, trade_date),
    INDEX idx_trade_date (trade_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='个股资金流向数据';