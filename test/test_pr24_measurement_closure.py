...
class TestLabelPerPeriodSchema:
    ...
    def test_delisting_haircut_is_frozen_not_runtime_tunable(self, synthetic_prices):
        """The legacy haircut constant is auditable but not a runtime knob."""
        ...
        with pytest.raises(TypeError):
            compute_executable_forward_returns(
                synthetic_prices, cal, delisting_haircut=0.50,
            )
