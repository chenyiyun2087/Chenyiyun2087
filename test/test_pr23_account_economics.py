...
class TestCanonicalLabelContract:
    ...
    def test_costs_deducted(self, synthetic_prices):
        ...
        from scripts.research.executable_labels import compute_executable_forward_returns
        result = compute_executable_forward_returns(synthetic_prices, cost_rate=0.002)
        ...
        if not valid.empty:
            ...
            result_no_cost = compute_executable_forward_returns(synthetic_prices, cost_rate=0.0)
            merged = valid.merge(
