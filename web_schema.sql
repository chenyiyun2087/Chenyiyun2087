...
CREATE TABLE IF NOT EXISTS score_rank_daily (
    ...
    buy_signal_description VARCHAR(255) COMMENT '最近买点描述',
    sell_signal_description VARCHAR(255) COMMENT '最近卖点描述',
    total_b_points INT COMMENT '最近批次B点总数',
    total_s_points INT COMMENT '最近批次S点总数',
    buy_points_count INT COMMENT '最近批次买点数量',
    sell_points_count INT COMMENT '最近批次卖点数量',
    event_seq_for_symbol INT COMMENT '该股票历史B点序号',
