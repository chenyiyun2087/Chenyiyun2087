...
if __name__ == "__main__":
    ...
    base_dir = r'D:\交易\investingPro'
    input_file = os.path.join(base_dir, f'cyy - cyy - {today_str}-filtered-subset.xlsx')
    input_file =r"cyy - cyy - 2025-09-01-filtered-2149.csv"
    try:
        ts = datetime.now().strftime('%Y%m%d_%H%M%S')
        output_pdf = os.path.join(script_dir, f'report_{ts}.pdf')
