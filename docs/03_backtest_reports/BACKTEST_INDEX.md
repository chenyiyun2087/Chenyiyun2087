...
## 2026-09-01 生产可信策略推荐前向周度复盘

- [2026-09-01 生产可信策略推荐前向一周复盘](2026-09-01_生产可信策略推荐前向一周复盘.md)：复盘 2026-08-17 至 08-21 的 25 条推荐在 2026-08-24 至 08-28 的表现；13 只去重池从周一开盘至周五收盘等权 +5.34%，推荐记录按 T+1 开盘至周五收盘等权 +4.53%，不含成本、滑点和实际成交。
- 原始明细：`exports/weekly_recommendation_reviews/20260817_20260821_to_20260824_20260828/`；可重跑脚本：`scripts/research/review_weekly_recommendation_performance.py`。
...
> 2026-07-20 全面可信生产升级：补齐 PIT V2 冻结器、双副本 Evidence、统一状态机、Fill 累计经济语义、离线账户对账、执行/成本 V2、CPCV、因子与实验注册、风险模型及资本门禁。没有新增收益结论；数据库、真实快照、双账本和观察期未完成前继续 `BLOCKED / NO_SCALE`。实施记录见 `docs/tasks/2026-07-20_全面可信生产升级实施.md`。
